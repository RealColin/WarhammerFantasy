...
public class BrownBearModel extends QuadrupedModel<BrownBearRenderState> {
    ...
    public static LayerDefinition createBodyLayer(boolean isBaby) {
        ...
        partDef.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 19).addBox(-5.0F, -13.0F, -7.0F, 14.0F, 14.0F, 11.0F).texOffs(39, 0).addBox(-4.0F, -25.0F, -7.0F, 12.0F, 12.0F, 10.0F), PartPose.offsetAndRotation(-2.0F, 9.0F, 12.0F, ((float)Math.PI / 2F), 0.0F, 0.0F));
        var builderOne = CubeListBuilder.create().texOffs(50, 22).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 10.0F, 8.0F);
        partDef.addOrReplaceChild("right_hind_leg", builderOne, PartPose.offset(-4.5F, 14.0F, 6.0F));
        partDef.addOrReplaceChild("left_hind_leg", builderOne, PartPose.offset(4.5F, 14.0F, 6.0F));
        var builderTwo = CubeListBuilder.create().texOffs(50, 40).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 10.0F, 6.0F);
        partDef.addOrReplaceChild("right_front_leg", builderTwo, PartPose.offset(-3.5F, 14.0F, -8.0F));
        partDef.addOrReplaceChild("left_front_leg", builderTwo, PartPose.offset(3.5F, 14.0F, -8.0F));
        return LayerDefinition.create(meshDef, 128, 64).apply(isBaby ? BABY_TRANSFORMER : MeshTransformer.IDENTITY).apply(MeshTransformer.scaling(1.2F));
    }
